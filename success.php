...
<div class=" col-md-4 offset-4">
    <img src="<?php echo $destination; ?>" class="img img-thumbnail" style="width: 70%; height: 70%" />
    <br><br>
    <div class="card " style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                Date Of Birth: <br> <?php echo $_POST['dob'];  ?>
            </p>
            <p class="card-text">
                Email Address: <br><?php echo $_POST['email'];  ?>
            </p>
            <p class="card-text">
                Phone Number: <br><?php echo $_POST['phone'];  ?>
            </p>
